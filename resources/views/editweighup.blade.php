...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header h5">Edit Weigh Up Check
        ...
        @endif
                	...
                	<form method="POST" action="/weighup/{{$weighups->id}}"><!--start form-->
                		{{csrf_field()}}
                		 @method('PATCH')
<div class="form-row">
...
<select class="form-control form-control-lg" name="w_ingredient" select="{{ $weighups->ingredient }}">
...
<!-- <div class="form-row form-group">
						    	 <label for="">Date & Time </label>
							    	<input class="form-control form-control-lg" type="text" id="result1" name="w_datetime" data-date-format="Y-MM-DD HH:mm:s"  value="{{ $weighups->datetime }}">
</div> -->

    <div class="form-row form-group">
                     <label for="">Number of Weigh Up</label>
                    <input class="form-control form-control-lg" type="number" pattern="[0-9]*" id="" name="NWEIGH" value="{{ $weighups->number_of_weighup }}">
                  </div>
...
<hr />
  ...
  <label id ="WT3" class="btn btn-secondary btn-lg">
    ...
    <div class="col-lg-3">
					  		...
					  		<hr />
<input style="display:none;" name="WTYPE" type="text" id="WTYPE" value="{{ $weighups->type }}">
<!-- <input style="display:none;" name="NWEIGH" type="text" id="NWEIGH" value="{{ $weighups->number_of_weighup }}"> -->
<input style="display:none ;" name="CWEIGHT" type="text" id="CWEIGHT" value="{{ $weighups->correct_weight }}">
<input style="display:none ;" name="CORRECTI" type="text" id="CORRECTI" value="{{ $weighups->correct_ingredient }}">
<input style="display:none ;" name="CORRECTL" type="text" id="CORRECTL" value="{{ $weighups->correct_label }}">
<input style="display: none;" name="CHECKCOMP" type="text" id="CHECKCOMP" value="{{ $weighups->checksheet_completed }}">
  ...
  <label id ="NW1" class="btn btn-secondary  btn-lg">
    <input type="radio" name="CI_yes" id="option1" autocomplete="off" value="Yes" > Yes
  </label>
  <label id="NW2" class="btn btn-secondary btn-lg">
  ...
  <label  id ="CW1"class="btn btn-secondary  btn-lg">
    <input type="radio" name="" id="option2" autocomplete="off" value="Yes"> Yes
  </label>
  <label  id ="CW2"class="btn btn-secondary btn-lg">
  ...
  <label id ="CI1" class="btn btn-secondary  btn-lg">
    <input type="radio" name="" id="option3" autocomplete="off" value="Yes"> Yes
  </label>
  <label id ="CI2" class="btn btn-secondary btn-lg">
  ...
  <label id ="CL1" class="btn btn-secondary  btn-lg">
    <input type="radio" name="" id="option4" autocomplete="off" value="Yes" > Yes
  </label>
  <label id ="CL2"class="btn btn-secondary btn-lg">
...
<hr />
  ...
  <textarea class="form-control" aria-label="With textarea" name="weigh_comments">{{$weighups->comments}}</textarea>
</div>
...
$("#select6 input:radio").change(function() {
   ...
   var o = $("#WTYPE").val();
if(o == "Small Ingredients"){	
	$("#WT1").toggleClass( "active", true );
}
if(o == "Chocolate"){
	$("#WT2").toggleClass( "active", true );
}
if(o == "Bulk Ingredients"){
	$("#WT3").toggleClass( "active", true );
}
