...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Check</div>
        ...
        @endif
                	...
                	<div class="form-row">
						     ...
						     <div class="form-group col-md-4">
							    	...
							    	<input class="form-control form-control-lg" type="text" id="result1" name="newcheck_datetime" data-date-format="Y-MM-DD HH:mm:s"  value="{{ $checks->check_datetime}}">
            	...
            	<!-- 	  <div class="form-row">
					...
					<!--   <div class="form-row">
					    ...
					    <div class="form-group col-md-2 ">
					      ...
					      <input type="text" class="form-control" name="individual_1" value="{{ $checks->check_inv_1}}">
					    </div>
					    <div class="form-group col-md-2">
					      <label for="individual_2">2</label>
					      <input type="text" class="form-control" name="individual_2" value="{{ $checks->check_inv_2}}">
					    </div>
					    <div class="form-group col-md-2">
					      <label for="individual_3">3</label>
					      <input type="text" class="form-control" name="individual_3" value="{{ $checks->check_inv_3}}">
					    </div>
					    <div class="form-group col-md-2">
					      <label for="individual_4">4</label>
					      <input type="text" class="form-control" name="individual_4" value="{{ $checks->check_inv_4}}">
					    </div>
					    <div class="form-group col-md-2">
					      <label for="individual_5">5</label>
					      <input type="text" class="form-control" name="individual_5" value="{{ $checks->check_inv_5}}">
					    </div>
					   ...
					   <div class="form-row">
					      ...
					      <input type="text" class="form-control" name="newcheck_individual_target_range" value="{{ $checks->check_inv_target_range}}">
					    </div>
					     <div class="form-group col-md-4">
					      <label for="">Average</label>
					      <input type="text" class="form-control" name="newcheck_individual_average" value="{{ $checks->check_inv_average}}">
					    </div>
					    ...
					    <div class="form-group col-md-2">
					      <label for="">1</label>
					      <input type="text" class="form-control" name="sample_1" value="{{ $checks->check_row_1}}">
					    </div>
					    <div class="form-group col-md-2">
					      <label for="">2</label>
					      <input type="text" class="form-control" name="sample_2" value="{{ $checks->check_row_2}}">
					    </div>
					    <div class="form-group col-md-2">
					      <label for="">3</label>
					      <input type="text" class="form-control" name="sample_3" value="{{ $checks->check_row_3}}">
					    </div>
					    ...
					    <div class="form-row">
					      ...
					      <input type="text" class="form-control" name="newcheck_sample_target_range" value="{{$checks->check_row_target_range}}">
					    </div>
					     <div class="form-group col-md-4">
					      <label for="inputEmail4">Average</label>
					      <input type="text" class="form-control" name="newcheck_sample_average" value="{{$checks->check_row_average}}">
					    </div>
					    ...
					    <div class="form-group col-md-4">
					      ...
					      <input type="text" class="form-control" name="newcheck_dough_temp" value="{{$checks->check_dough_temp}}">
					    </div>
					    <div class="form-group col-md-4">
					      <label for="inputPassword4">Flour Temp</label>
					      <input type="text" class="form-control" name="newcheck_flour_temp" value="{{$checks->check_flour_temp}}">
					    </div>
					     <div class="form-group col-md-4">
					      <label for="inputPassword4">Butter Temp</label>
					      <input type="text" class="form-control" name="newcheck_butter_temp" value="{{$checks->check_butter_temp}}">
					    </div>
					  </div>
