    ...
    <div class="row justify-content-center">
        ...
        @endif
            	...
            	<!-- 	  <div class="form-row">
					...
					<!--   <div class="form-row">
					    ...
					    <!--   <label for="individual_1">1</label> -->
					      <input type="number" step="any" class="form-control kd2" name="individual_1" value="{{ old('individual_1') }}">
					    </div>
					    <div class="form-group col-sm-2">
					      <!-- <label for="individual_2">2</label> -->
					      <input type="number" step="any" class="form-control kd2" name="individual_2" value="{{ old('individual_2') }}">
					    </div>
					    <div class="form-group col-sm-2">
					      <!-- <label for="individual_3">3</label> -->
					      <input type="number" step="any" class="form-control kd2" name="individual_3" value="{{ old('individual_3') }}">
					    </div>
					    <div class="form-group col-sm-2">
					      <!-- <label for="individual_4">4</label> -->
					      <input type="number" step="any" class="form-control kd2" name="individual_4" value="{{ old('individual_4') }}">
					    </div>
					    <div class="form-group col-sm-2">
					      <!-- <label for="individual_5">5</label> -->
					      <input type="number" step="any" class="form-control kd2" name="individual_5" value="{{ old('individual_5') }}">
					    </div>
					    ...
					    <div class="form-group col-sm-2 ">
					    <!--   <label for="individual_1">1</label> -->
					      <input type="number" step="any" class="form-control kd3" name="re_individual_1" value="{{ old('individual_1') }}">
					    </div>
					    <div class="form-group col-sm-2">
					      <!-- <label for="individual_2">2</label> -->
					      <input type="number" step="any" class="form-control kd3" name="re_individual_2" value="{{ old('individual_2') }}">
					    </div>
					    <div class="form-group col-sm-2">
					      <!-- <label for="individual_3">3</label> -->
					      <input type="number" step="any" class="form-control kd3" name="re_individual_3" value="{{ old('individual_3') }}">
					    </div>
					    <div class="form-group col-sm-2">
					      <!-- <label for="individual_4">4</label> -->
					      <input type="number" step="any" class="form-control kd3" name="re_individual_4" value="{{ old('individual_4') }}">
					    </div>
					    <div class="form-group col-sm-2">
					      <!-- <label for="individual_5">5</label> -->
					      <input type="number" step="any" class="form-control kd3" name="re_individual_5" value="{{ old('individual_5') }}">
					    </div>
				...
				<div class="form-row ">
					    <div class="form-group col-md-2">
					      <!-- <label for="">1</label> -->
					      <input type="number" step="any" class="form-control kd1" name="sample_1" placeholder="" value="{{ old('sample_1') }}">
					    </div>
					    <div class="form-group col-md-2">
					     <!--  <label for="">2</label> -->
					      <input type="number" step="any" class="form-control kd1" name="sample_2" placeholder="" value="{{ old('sample_2') }}">
					    </div>
					    <div class="form-group col-md-2">
					      <!-- <label for="">3</label> -->
					      <input type="number" step="any" class="form-control kd1" name="sample_3" placeholder="" value="{{ old('sample_3') }}">
					    </div>
				...
				<div class="form-row row_retest" style="display: none;">
					    <div class="form-group col-md-2">
					      <!-- <label for="">1</label> -->
					      <input type="number" step="any" class="form-control kd4" name="re_sample_1" placeholder="" value="{{ old('sample_1') }}">
					    </div>
					    <div class="form-group col-md-2">
					     <!--  <label for="">2</label> -->
					      <input type="number" step="any" class="form-control kd4" name="re_sample_2" placeholder="" value="{{ old('sample_2') }}">
					    </div>
					    <div class="form-group col-md-2">
					      <!-- <label for="">3</label> -->
					      <input type="number" step="any" class="form-control kd4" name="re_sample_3" placeholder="" value="{{ old('sample_3') }}">
					    </div>
					...
					<!--      	 <label for="inputEmail4" class="invisible">--</label>  -->
					    ...
					    <div class="form-group col-md-4">
					      ...
					      <input type="number" step="any" class="form-control" name="newcheck_dough_temp" value="{{ old('newcheck_dough_temp') }}">
					    </div>
					    <div class="form-group col-md-4">
					      <label for="inputPassword4">Flour Temp</label>
					      <input type="number" step="any" class="form-control" name="newcheck_flour_temp" value="{{ old('newcheck_flour_temp') }}">
					    </div>
					     <div class="form-group col-md-4">
					      <label for="inputPassword4">Butter Temp</label>
					      <input type="number" step="any" class="form-control" name="newcheck_butter_temp" value="{{ old('newcheck_butter_temp') }}">
					    </div>
					  </div>
    ...
    $("#product_selector").change(function(e){
        ...
        $.ajax({
           ...
           success:function(data){
            ...
            var inv_max = (data.target_range_row_min + " - " + data.target_range_row_max);
            $("#trange1").val(inv_min);
            $("#trange2").val(inv_max);
